...
#include <array>
	struct col_t
	{
		...
		struct palette_t
		{
			...
			static col_t white(int alpha = 255) { return col_t(220, 220, 220, alpha); }
			...
			static col_t light_blue(int alpha = 255) { return col_t(100, 149, 237, alpha); }
			static col_t blue_violet(int alpha = 255) { return col_t(138, 43, 226, alpha); }
		};
